...
async def help(ctx):
    em = discord.Embed(title='Shadow Boost commands list', description='Can only be used by admins!', color=0xe91e63)
...
async def pay(ctx):
    ...
    eme.add_field(name='Paypal', value='https://paypal.me/LittleLen4')
